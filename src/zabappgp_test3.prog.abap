...
FORM run1.
  ...
  DATA(lo_v) = zcl_abappgp_integer=>from_string( '66667777' ).
...
FORM run4.
  ...
  DATA(lo_u) = zcl_abappgp_integer=>from_string( '900000000000' ).
  DATA(lo_v) = zcl_abappgp_integer=>from_string( '200000000000' ).
