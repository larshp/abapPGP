CLASS zcl_abappgp_subpacket_24 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_ABAPPGP_SUBPACKET_24 IMPLEMENTATION.
...
* todo
  ...
  METHOD zif_abappgp_subpacket~get_type.
    ...
    rv_type = zif_abappgp_constants=>c_sub_type-preferred_key_server.
