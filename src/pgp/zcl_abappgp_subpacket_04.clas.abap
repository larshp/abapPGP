CLASS zcl_abappgp_subpacket_04 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_ABAPPGP_SUBPACKET_04 IMPLEMENTATION.
...
* todo
  ...
  METHOD zif_abappgp_subpacket~get_name.
    ...
    rv_name = 'Exportable Certification'.
  ...
  METHOD zif_abappgp_subpacket~get_type.
    ...
    rv_type = zif_abappgp_constants=>c_sub_type-exportable_certification.
