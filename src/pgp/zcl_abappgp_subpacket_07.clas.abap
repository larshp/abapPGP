class ZCL_ABAPPGP_SUBPACKET_07 definition
  public
  create public .
...
CLASS ZCL_ABAPPGP_SUBPACKET_07 IMPLEMENTATION.
...
* todo
  ...
  METHOD zif_abappgp_subpacket~get_type.
    ...
    rv_type = zif_abappgp_constants=>c_sub_type-revocable.
