class ZCL_ABAPPGP_SUBPACKET_06 definition
  public
  create public .
...
CLASS ZCL_ABAPPGP_SUBPACKET_06 IMPLEMENTATION.
...
* todo
  ...
  METHOD zif_abappgp_subpacket~get_type.
    ...
    rv_type = zif_abappgp_constants=>c_sub_type-regular_expression.
